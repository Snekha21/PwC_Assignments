package com.CRUD.InternManagementSystem.config;
...
public class OpenAPIConfig {
  ...
  public OpenAPI myOpenAPI() {
    ...
    Info info = new Info()
        .title("Interns Management API")
        .version("1.0")
        .contact(contact)
        .description("This API exposes endpoints to manage trainings.").termsOfService("https://www.test.com/terms")
        .license(mitLicense);
